...
| **flutter-qa**         |      v3.1      | ビルド/分析/テストサイクル       |
...
|  #  | 項目                    | 状態 | 備考                           |
| :-: | ----------------------- | :--: | ------------------------------ |
|  1  | Flutter SDK 使用可能    |  ⬜  | flutter --version              |
|  2  | 目標タイプ確認          |  ⬜  | --all/--analyze/--test/--build |
|  3  | プロジェクトルート確認  |  ⬜  | pubspec.yaml 存在              |
...
|  #  | 項目                      | 状態 | 備考                 |
| :-: | ------------------------- | :--: | -------------------- |
|  1  | 目標検査すべて通過        |  ⬜  | analyze/test/build   |
...
| :-: | ------------------------- | :--: | ----------------------- |
|  1  | 検証対象明確              |  ⬜  | 作業範囲確認            |
|  2  | 完了条件定義済み          |  ⬜  | flutter analyze/test 等 |
|  3  | 最大反復回数設定          |  ⬜  | デフォルト 5回          |
...
| ---------------- | :------: | ----------------------------- | ---------------------------- |
| flutter analyze  |   30分   | `lib/**/*.dart` 変更          | `evidence.flutter_analyze`   |
| flutter test     |   30分   | `test/**/*.dart` 変更         | `evidence.flutter_test`      |
| flutter build    |  1時間   | `lib/**`, `pubspec.yaml` 変更 | `evidence.flutter_build`     |
...
| [flutter-qa SKILL.md](../flutter-qa/SKILL.md)       | ESP v3.1 例            |
