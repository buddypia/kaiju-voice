...
/**
 * oh-my-claude-code Pre-Tool Enforcer Hook (PreToolUse - Sisyphus)
 *
 * oh-my-opencodeのpre-tool-enforcer.mjsをClaude Code Hooks に移植。
 ...
 * - oh-my-claude-codeスキルシステムに合わせたメッセージ
 *
 ...
 * oh-my-claude-code形式: [MODE - PROGRESS | Tasks: N]
 */
